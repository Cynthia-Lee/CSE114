...
/*		RewardsCard c4 = new RewardsCard("Bucket Man", 8654460623450813l, 1015, 10000);
		Transaction te = new Transaction("debit","Company",30);
		c4.addTransaction(te);
		System.out.println(te.amount());
		System.out.println(c4.availableCredit());
		System.out.println(c4.addTransaction(te));
		System.out.println(c4.balance());
		System.out.println(c4.rewardPoints());
		*/
